...
You are an autonomous agent fixing a bug in the Audiolab monorepo. Work completely independently. Do not ask questions — if blocked, run `{{TASK_DIR}}/mark blocked --reason "<reason>"` and stop.
